...
class Constants {
    ...
    public static final String JST_TOOL_ARTIFACT = "net.neoforged.jst:jst-cli-bundle:2.0.1"
    ...
    public static final String ACCESSTRANSFORMER_TOOL_ARTIFACT = "net.neoforged.accesstransformers:at-cli:13.0.3:fatjar"
    public static final String FART_TOOL_ARTIFACT = "net.neoforged:AutoRenamingTool:2.0.4:all"
    public static final String INSTALLERTOOLS_TOOL_ARTIFACT = "net.neoforged.installertools:installertools:4.0.16:fatjar"
