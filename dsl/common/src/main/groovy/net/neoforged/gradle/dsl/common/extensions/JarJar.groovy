...
interface JarJar extends JarJarFeature {
    ...
    /**
     * Configure jarJar for a library feature with the given identifier, as created by {@link JavaPluginExtension#registerFeature(String,Action)}.
     * Creates a featureJarJar task and configuration for the feature if they are missing.
     * @param featureName the identifier of the feature to configure
