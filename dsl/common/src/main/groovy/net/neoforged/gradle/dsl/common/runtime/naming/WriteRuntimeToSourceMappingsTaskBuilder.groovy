...
@FunctionalInterface
@CompileStatic
interface WriteRuntimeToSourceMappingsTaskBuilder {

    /**
     * Invoked to construct a new task provider for a runtime to source mappings file from the given context.
     *
