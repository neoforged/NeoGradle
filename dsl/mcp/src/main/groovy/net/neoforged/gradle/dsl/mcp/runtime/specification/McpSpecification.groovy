package net.neoforged.gradle.dsl.mcp.runtime.specification
...
interface McpSpecification extends Specification {
    ...
    interface Builder<S extends McpSpecification, B extends Builder<S, B>> extends Specification.Builder<S, B> {
         ...
         */
        @NotNull
        B withMcpVersion(@NotNull final Provider<String> mcpVersion);
         ...
         */
        @NotNull
        B withMcpVersion(@NotNull final String mcpVersion);
