...
public class UserDevConfigurationSpecV1 extends VersionedConfiguration {
    ...
    public static UserDevConfigurationSpecV1 get(InputStream stream) {
        return GSON.fromJson(new InputStreamReader(stream), UserDevConfigurationSpecV1.class);
    }
    ...
    private Map<String, RunConfigurationSpec> runs = Maps.newHashMap();
     ...
     */
    public Map<String, RunConfigurationSpec> getRunConfigurationSpecifications() {
        return runs;
    }
