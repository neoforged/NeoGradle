...
@CacheableTask
public abstract class DownloadMCPMappings extends DownloadingTask {
    ...
    private File getMappingFile() {
        ...
        Provider<File> ret = getDownloader().flatMap(downloader -> downloader.generate(artifact, false));
        if (!ret.isPresent())
