...
import static net.minecraftforge.gradle.common.util.IMappingFileUtils.Element.CLASS;
import static net.minecraftforge.gradle.common.util.IMappingFileUtils.Element.FIELD;
import static net.minecraftforge.gradle.common.util.IMappingFileUtils.Element.METHOD;
import static net.minecraftforge.gradle.common.util.IMappingFileUtils.Element.PARAMETER;
